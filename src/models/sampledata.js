...
export async function addSampleData (callback) {
    ...
    try {
        ...
        const comment1 = await comments.findOne({num: 1});
        const comment2 = await comments.findOne({num: 2});
        const comment3 = await comments.findOne({num: 3});
        ...
        const result2 = await posts.insertMany([
            ...
            },
            {
                ...
                votes: 131,
                num_comments: 2,
                comments_id: [comment4._id, comment5._id],
                edited: false
            },
            {
                num: 4,
            ...
            },
            {
                ...
                votes: 0,
                num_comments: 2,
                comments_id: [comment1._id, comment2._id],
                edited: false
            }
        ]);
